  ...
  function generateManager(manager) {
    ...
    <div class="card">
      <div class="card-body">
        ...
        <h6 class="second-title">Manager</h6>
  ...
  function generateEngineer(engineer) {
    ...
    <div class="card">
      <div class="card-body">
        ...
        <h6 class="second-title">Engineer</h6>
        ...
        <p class="card-text">Id:${engineer.engineerId}</p>
        <p class="card-text">Email:${engineer.engineerEmail}</p>
 ...
 let result = "";
  ...
  for (let i = 0; i < myTeam.length; i++) {
    if (myTeam[i].officeNumber) {
     result +=  generateManager(myTeam[i]);
    } else if (myTeam[i].gitHub) {
      result += generateEngineer(myTeam[i]);
    } else {
     result +=  generateIntern(myTeam[i]);
    } 
  }
  return result;
};
